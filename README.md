...
Cf. [here](docs/sample_invocations.txt) for sample invocations of [`splitZed`](src/apps/splitZed), [`calibrateCam`](src/apps/calibrateCam), [`calibrateProj`](src/apps/calibrateProj), and [`applyHomography`](src/apps/applyHomography) (find the corresponding sample images [here](docs/sample_data), to be used for running the sample invocations as of `calibrateCam`)...

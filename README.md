...
* **space bar**: toggle between interpreting mouse movements for controlling the rotational component of OpenGL's camera and locking the rotational component of OpenGL's camera

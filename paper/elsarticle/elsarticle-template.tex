...
\begin{figure}
    ...
    \caption{Projection from recovered projector viewpoint (bottom left, black) to scene plane of original image and of warped image. (a) Projecting the original 960~pixel~$\times$~600~pixel image ... (b) After warping the original image accoring to the plane-induced homography for the given target location, the image is projected in a manner that appears ...}
    \label{fig:warp}
\end{figure}

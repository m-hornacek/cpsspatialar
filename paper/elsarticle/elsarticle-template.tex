...
\begin{figure}[t]
    ...
    \qquad
    \subfloat[\centering Projection from side to scene plane (viewed directly downwards to scene plane).]{{\includegraphics[width=6cm]{images/proj_projim_full_.png}}}
...
\begin{figure}[t]
    ...
    \qquad
    \subfloat[\centering Projection from side to scene plane (viewed directly downwards to scene plane).]{{\includegraphics[width=6cm]{images/proj_projim_waped_full_.png}}}

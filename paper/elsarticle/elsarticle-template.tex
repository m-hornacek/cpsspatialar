...
\begin{keyword}
Spatial augmented reality (SAR) \sep computer vision \sep projector calibration \sep steerable mirror projection \sep Industry 4.0 \sep Pilotfabrik
\end{keyword}

...
\begin{figure}
    ...
    \qquad
    \subfloat[\centering Projection to target location in scene plane (view downwards to scene plane).]{{\includegraphics[height=3.4cm]{images/proj_projim.png}}}
...
\begin{figure}
    ...
    \qquad
    \subfloat[\centering Projection to target location in scene plane (view downwards to scene plane).]{{\includegraphics[height=3.4cm]{images/proj_projim_waped.png}}}
...
\begin{figure}[ht]
    \centering
    \subfloat[\centering Projector calibration image (2D pattern position detections overlain).]{{\includegraphics[height=3.1cm]{images/detections.png} }}
    \qquad
    \subfloat[\centering Corresponding 3D positions for use in projector calibration (red, in scene plane).]{{\includegraphics[height=3.1cm]{images/2d3d.png}}}
...
\begin{figure}
    ...
    \qquad
    \subfloat[\centering View downwards to scene plane.]{{\includegraphics[height=4.2cm]{images/3_above3_cam.png}}}
...
\begin{figure}
    ...
    \qquad
    \subfloat[\centering View downwards to scene plane.]{{\includegraphics[height=4.2cm]{images/3_above3_proj.png}}}
...
\begin{figure}
    ...
    \caption{Projection of the warped image from Figure \ref{fig:warp}(a) to corresponding target location, acquired by the `downwards-facing' camera. Note that besides correcting for projective distortions, the warp places the axes of the augmentation in accordance with the axes of the `downwards-facing' camera, and that the dimensions of the augmentation are in line with the desired target dimensions (50~cm~$\times$~31.25~cm). To provide context, the corners of the full projected image extent are projected to the floor in light green (emphasized with overlain dashed circles).}

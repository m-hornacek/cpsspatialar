...
\begin{figure}[t]
    ...
    \qquad
    \subfloat[\centering View directly downwards to scene~plane.]{{\includegraphics[height=5.25cm]{images/3_above3_cam.pdf}}}
...
\begin{figure}[t]
    ...
    \qquad
    \subfloat[\centering View directly downwards to scene~plane.]{{\includegraphics[height=5.25cm]{images/3_above3_proj.pdf}}}
...
\begin{figure}
    \centering
    \subfloat[\centering Hardware setup consisting of projector, steerable mirror system, `downwards-facing' camera (i.e., camera placed to face downards towards the scene plane, here the left view of a stereo camera).]{{\includegraphics[height=5cm]{images/system3_.pdf}}}  %3.6
    \quad

...
\begin{figure}[t]
    \centering
    \subfloat[\centering Projector calibration image (2D pattern position detections overlain).]{{\includegraphics[width=5.85cm]{images/detections_.png}}}
    \quad
    \subfloat[\centering Recovered 3D positions corresponding to projector calibration image for use in projector calibration (red, in scene plane).]{{\includegraphics[height=4.75cm]{images/2d3d.pdf}}}

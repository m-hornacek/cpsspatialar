...
\begin{figure}[t]
    \centering
    \subfloat[\centering Original image (to be projected).]{\raisebox{10mm}{\includegraphics[width=5cm]{images/projim.png}}}
    \qquad
    \subfloat[\centering Projection from side to scene plane (viewed directly downwards to scene plane).]{{\includegraphics[width=6cm]{images/proj_projim_full_.pdf}}}
...
\begin{figure}[t]
    \centering
    \subfloat[\centering Projector calibration image (2D position detections of chessboard pattern and asymmetric circle pattern overlain).]{{\includegraphics[width=5.85cm]{images/detections_.png}}}
    \quad
    \subfloat[\centering Recovery of corresponding 3D positions of asymmetric circle pattern for use in projector calibration (red, in scene plane).]{{\includegraphics[height=4.75cm]{images/2d3d.pdf}}}
...
\begin{figure}
    \centering
    \subfloat[\centering Hardware setup consisting of a Panasonic PT-RZ660BE projector, a steerable mirror system manufactured by Dynamic Projection Institute, and the left view of a Stereolabs Zed 2 stereo camera---placed to face downwards towards the scene plane---to serve as the `downwards-facing' camera.]{{\includegraphics[height=5cm]{images/system3_.pdf}}}  %3.6
    \quad

...
\begin{figure}[ht]
    ...
    \qquad
    \subfloat[\centering Corresponding 3D positions for use in projector calibration (red, in scene plane).]{{\includegraphics[height=3.26cm]{images/2d3d.png}}}
...
\begin{figure}
    \centering
    \includegraphics[height=4cm]{images/hans_undist_.pdf}

...
\begin{keyword}
Spatial augmented reality (SAR) \sep computer vision \sep projector calibration \sep steerable mirror projector \sep Industry 4.0 \sep Pilotfabrik
\end{keyword}

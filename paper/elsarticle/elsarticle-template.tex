...
\begin{figure}
    ...
    \quad
    \subfloat[\centering Measurement for example target location, using a steel rule and a digital angle gauge.]{{\includegraphics[height=3.6cm]{images/meas2_.pdf}}}

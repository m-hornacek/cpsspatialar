...
\begin{figure}[ht]
    ...
    \qquad
    \subfloat[\centering Corresponding 3D positions for use in projector calibration (red, in scene plane).]{{\includegraphics[height=3.5cm]{images/2d3d.png}}}
...
\begin{figure}
    \centering
    \subfloat[\centering Hardware setup (projector, steerable mirror system, camera).]{{\includegraphics[height=4.75cm]{images/system3_.pdf}}}  %3.6
    \quad
    \subfloat[\centering Measurement for augmentation, using a steel rule and a digital angle gauge (enlargements on the right).]{{\includegraphics[height=4.75cm]{images/meas2_.pdf}}}

...
\begin{figure}
    \centering
    \subfloat[\centering Asymetrical circle pattern image, in image plane of projector (detections overlain).]{{\includegraphics[height=3.25cm]{images/circles.png} }}
    \qquad
